...
public class CalendarManagerTest {
    ...
    public void periode_rdvHorsPlage() {
        calendar.ajouter(new RendezVous("Hors plage", "alice", LocalDateTime.of(2025, 7, 1, 9, 0), 60));
        LocalDateTime debut = LocalDateTime.of(2025, 6, 1, 0, 0);
        LocalDateTime fin = LocalDateTime.of(2025, 6, 30, 23, 59);
    ...
    public void periode_melangeInOut() {
        ...
        calendar.ajouter(new RendezVous("Juillet", "alice", LocalDateTime.of(2025, 7, 1, 9, 0), 60));
        LocalDateTime debut = LocalDateTime.of(2025, 6, 1, 0, 0);
        LocalDateTime fin = LocalDateTime.of(2025, 6, 30, 23, 59);
    ...
    public void periode_periodiqueAvecOccurrenceDansPlage() {
        calendar.ajouter(new Periodique("Stand-up", "alice", LocalDateTime.of(2025, 6, 1, 9, 0), 7));
        LocalDateTime debut = LocalDateTime.of(2025, 6, 1, 0, 0);
        LocalDateTime fin = LocalDateTime.of(2025, 6, 30, 23, 59);
    ...
    public void periode_periodiqueHorsPlage() {
        calendar.ajouter(new Periodique("Stand-up tardif", "alice", LocalDateTime.of(2025, 7, 1, 9, 0), 7));
        LocalDateTime debut = LocalDateTime.of(2025, 6, 1, 0, 0);
        LocalDateTime fin = LocalDateTime.of(2025, 6, 30, 23, 59);
        assertTrue(calendar.eventsDansPeriode(debut, fin).isEmpty());
    }
